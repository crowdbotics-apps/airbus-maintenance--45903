"""
Django settings for airbus_maintenance__45903 project.
...
ROOT_URLCONF = 'airbus_maintenance__45903.urls'
...
WSGI_APPLICATION = 'airbus_maintenance__45903.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "airbus_maintenance__45903 API",
    "DESCRIPTION": "API documentation for airbus_maintenance__45903 App",
    "VERSION": "v1",
}
